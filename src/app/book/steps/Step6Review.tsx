      ...
      <div className="space-y-6">
        ...
        {price && (
          <div className="bg-forest/5 rounded-md p-5">
            ...
            {price.foundingDiscount > 0 && (
              <div className="flex justify-between py-2 border-b border-cream-dark">
                <span className="font-body text-sm text-forest font-medium">
                  Founding Customer Rate
                </span>
                <span className="font-body text-sm font-medium text-forest text-right">
                  -${price.foundingDiscount.toFixed(2)}
                </span>
              </div>
            )}
            ...
            {price.foundingDiscount > 0 && (
              <p className="flex items-center gap-1.5 font-body text-xs text-forest mt-2">
                ...
                You&apos;re one of our first 20 customers — founding rate applied automatically.
              </p>
            )}
