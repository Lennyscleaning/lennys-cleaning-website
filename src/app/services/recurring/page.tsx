...
export const metadata: Metadata = {
  ...
  description:
    'Save up to 15% with recurring house cleaning in Tacoma. Weekly, biweekly, or monthly plans with the same vetted professional every visit. Cancel or change anytime.',
  openGraph: {
    title: "Recurring House Cleaning | Lenny's Cleaning — Tacoma, WA",
    description:
      'Save up to 15% with recurring house cleaning in Tacoma. Weekly, biweekly, or monthly plans with the same vetted professional every visit.',
  },
};
